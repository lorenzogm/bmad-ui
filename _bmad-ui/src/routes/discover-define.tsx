...
const DISCOVER_DEFINE_PHASE_IDS = [
	"analysis",
	"planning",
	"solutioning",
] as const;
...
function PhaseStepsTable(props: {
	...
	const { phase, runtimeSessions, activeSkill, pendingSkill, onRunSkill } =
		props;
		...
		<main className="screen">
			<section className="panel reveal">
				...
				<p className="subtitle mb-6">
					Explore the three phases that shape your product before development
					begins.
				</p>
