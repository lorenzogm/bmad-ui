...
## Data and State
- Runtime state file: _bmad-ui/bmad-orchestrator/runtime-state.json
- Analytics output: _bmad-ui/bmad-orchestrator/analytics.json
- Session prompt/log artifacts: _bmad-ui/bmad-orchestrator/logs/*
...
- Main script entrypoint: _bmad-ui/bmad-orchestrator/orchestrator.mjs
